...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="css/admin_nav3.css">
...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <li class="search-box">
                    ...
                    <i class='bx bxs-dashboard bx-tada bx-flip-vertical icon' ></i>
    ...
    <section class="home">
        <div class="text"> " Hey Admin ! here is your Dashboard "
            ...
            <div class="d-flex">
                ...
                <div>
                    <div class="d-flex m-b">
                        <a href="admin_manage_jobs.php">
                            <button class="view-jobs-design"> <b>Manage Jobs Post </b></button>
                        </a>
                    </div>
                    <div class="d-flex">
                        <a href="admin_manage_users.php"><button class="post-jobs-design"><b>Manage Users Account </b></button></a>
                    </div>
                </div>
